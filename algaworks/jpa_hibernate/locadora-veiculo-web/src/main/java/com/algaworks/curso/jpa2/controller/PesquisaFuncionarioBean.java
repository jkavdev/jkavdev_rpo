...
public class PesquisaFuncionarioBean implements Serializable {
	...
	private LazyFuncionarioDataModel lazyFuncionario;

	public void excluir() {
		try {
			funcionarioDAO.excluir(funcionarioSelecionado);
			this.funcionarios.remove(funcionarioSelecionado);
			FacesUtil.addSuccessMessage("Funcionario " + funcionarioSelecionado.getNome() + " excluido com sucesso!");
	...
	@PostConstruct
	public void init() {
		lazyFuncionario = new LazyFuncionarioDataModel(funcionarioDAO);
	}
	...
	public void setMotoristas(List<Funcionario> funcionarios) {
	...
	public LazyFuncionarioDataModel getLazyFuncionario() {
