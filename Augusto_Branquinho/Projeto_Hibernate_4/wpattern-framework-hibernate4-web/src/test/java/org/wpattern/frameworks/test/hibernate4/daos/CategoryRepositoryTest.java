...
public class CategoryRepositoryTest {
	 ...
	 Logger.getLogger(CategoryRepositoryTest.class);
...
//		// System.out.println(categories);
//
//		List<CategoryEntity> categories = categoryDAO.findByCategoryName("Beverages");
//
//		LOGGER.info(categories);
...
//	}
	...
	public void testFindCategoryName() {
		 ...
		 this.categoryDAO.findByCategoryName("Beverages");
